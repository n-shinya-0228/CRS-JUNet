...
TRAINER_DIR = osp.join(osp.dirname(osp.abspath(__file__)), "lib", "trainer")
if TRAINER_DIR not in sys.path:
  sys.path.insert(0, TRAINER_DIR)
from trainer_PointNet import Trainer
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser("./train_pointnet_hybrid.py")    #引数指定
  parser.add_argument(
      '--dataset', '-d',
      type=str,
      required=True,

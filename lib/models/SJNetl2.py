...
class SJNetl2(nn.Module):
    ...
    def __init__(
        ...
        # decoder
        self.up4 = UpBlock2(base_ch * 8, base_ch * 8, base_ch * 8, drop=drop)
        self.up3 = UpBlock2(base_ch * 8, base_ch * 4, base_ch * 4, drop=drop)
